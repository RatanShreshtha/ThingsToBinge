...
const formattedReleaseDate = useDateFormat(content.release_date, 'DD MMMM, YYYY')
</script>
    ...
    <div class="card-content">
      <div class="columns is-multiline">
        <div class="column is-full">
          ...
          <p class="subtitle" v-if="content.tagline">
            {{ content.tagline }}
          </p>
        </div>
        ...
        <div class="column is-two-thirds">
          ...
          <div class="block">
            ...
            <p>
              <strong>Ratings:</strong> {{ usePrecision(content.vote_average, 1) }}
            </p>
            <p>
            ...
            <p>
              <strong>Budget:</strong> ${{ content.budget }}.00
            </p>
            <p>
              <strong>Revenue:</strong> ${{ content.revenue }}.00
            </p>
            <p>
